...
# Set to 0 the AMPA gmax as in NBQX
gocs.MF_L[0].postsyns['AMPA'][0].gmax = 0
# Remove Mg block
gocs.MF_L[0].postsyns['NMDA'][0].v0_block = -200

# shuld be:
# NMDA at -70 mV with MG block removed should give -34 pA
# t20-80 = 5 ms
