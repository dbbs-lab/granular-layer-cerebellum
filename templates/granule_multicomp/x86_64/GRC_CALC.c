...
#define nrn_init _nrn_init__GRC_CALC
#define _nrn_initial _nrn_initial__GRC_CALC
#define nrn_cur _nrn_cur__GRC_CALC
#define _nrn_current _nrn_current__GRC_CALC
#define nrn_jacob _nrn_jacob__GRC_CALC
#define nrn_state _nrn_state__GRC_CALC
#define _net_receive _net_receive__GRC_CALC 
#define conc conc__GRC_CALC 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRC_CALC /home/neuron/projects/rete/control_sims/weasel/templates/granule_multicomp/x86_64/GRC_CALC.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcai = - ica / ( 2.0 * F * d ) * ( 1e4 ) - beta * ( cai - cai0 ) ;
   }
 return _reset;
}
