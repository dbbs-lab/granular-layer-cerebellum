...
#define nrn_init _nrn_init__GRC_KIR
#define _nrn_initial _nrn_initial__GRC_KIR
#define nrn_cur _nrn_cur__GRC_KIR
#define _nrn_current _nrn_current__GRC_KIR
#define nrn_jacob _nrn_jacob__GRC_KIR
#define nrn_state _nrn_state__GRC_KIR
#define _net_receive _net_receive__GRC_KIR 
#define _f_rate _f_rate__GRC_KIR 
#define rate rate__GRC_KIR 
#define states states__GRC_KIR 
...
extern Memb_func* memb_func;
 ...
 "setdata_GRC_KIR", _hoc_setdata,
 "alp_d_GRC_KIR", _hoc_alp_d,
 "bet_d_GRC_KIR", _hoc_bet_d,
 "rate_GRC_KIR", _hoc_rate,
 0, 0
};
#define alp_d alp_d_GRC_KIR
#define bet_d bet_d_GRC_KIR
...
#define usetable usetable_GRC_KIR
 double usetable = 1;
 ...
 "Aalpha_d_GRC_KIR", "/ms",
 "Kalpha_d_GRC_KIR", "mV",
 "V0alpha_d_GRC_KIR", "mV",
 "Abeta_d_GRC_KIR", "/ms",
 "Kbeta_d_GRC_KIR", "mV",
 "V0beta_d_GRC_KIR", "mV",
 "gkbar_GRC_KIR", "mho/cm2",
 "ik_GRC_KIR", "mA/cm2",
 "tau_d_GRC_KIR", "ms",
 "g_GRC_KIR", "mho/cm2",
 "alpha_d_GRC_KIR", "/ms",
 ...
 "usetable_GRC_KIR", &usetable_GRC_KIR,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRC_KIR /home/neuron/projects/rete/control_sims/weasel/templates/granule_multicomp/x86_64/GRC_KIR.mod\n");
