...
#define nrn_init _nrn_init__GRC_KV
#define _nrn_initial _nrn_initial__GRC_KV
#define nrn_cur _nrn_cur__GRC_KV
#define _nrn_current _nrn_current__GRC_KV
#define nrn_jacob _nrn_jacob__GRC_KV
#define nrn_state _nrn_state__GRC_KV
#define _net_receive _net_receive__GRC_KV 
#define _f_rate _f_rate__GRC_KV 
#define rate rate__GRC_KV 
#define states states__GRC_KV 
...
extern Memb_func* memb_func;
 ...
 "setdata_GRC_KV", _hoc_setdata,
 "alp_n_GRC_KV", _hoc_alp_n,
 "bet_n_GRC_KV", _hoc_bet_n,
 "linoid_GRC_KV", _hoc_linoid,
 "rate_GRC_KV", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GRC_KV
#define bet_n bet_n_GRC_KV
#define linoid linoid_GRC_KV
...
#define usetable usetable_GRC_KV
 double usetable = 1;
 ...
 "Aalpha_n_GRC_KV", "/ms-mV",
 "Kalpha_n_GRC_KV", "mV",
 "V0alpha_n_GRC_KV", "mV",
 "Abeta_n_GRC_KV", "/ms",
 "Kbeta_n_GRC_KV", "mV",
 "V0beta_n_GRC_KV", "mV",
 "gkbar_GRC_KV", "mho/cm2",
 "ik_GRC_KV", "mA/cm2",
 "tau_n_GRC_KV", "ms",
 "g_GRC_KV", "mho/cm2",
 "alpha_n_GRC_KV", "/ms",
 ...
 "usetable_GRC_KV", &usetable_GRC_KV,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRC_KV /home/neuron/projects/rete/control_sims/weasel/templates/granule_multicomp/x86_64/GRC_KV.mod\n");
