...
#define nrn_init _nrn_init__GRANULE_Ampa_stoch_vi
#define _nrn_initial _nrn_initial__GRANULE_Ampa_stoch_vi
#define nrn_cur _nrn_cur__GRANULE_Ampa_stoch_vi
#define _nrn_current _nrn_current__GRANULE_Ampa_stoch_vi
#define nrn_jacob _nrn_jacob__GRANULE_Ampa_stoch_vi
#define nrn_state _nrn_state__GRANULE_Ampa_stoch_vi
#define _net_receive _net_receive__GRANULE_Ampa_stoch_vi 
#define kstates kstates__GRANULE_Ampa_stoch_vi 
...
#define Erev _p[15]
#define kB _p[16]
#define kB_factor _p[17]
#define Tmax _p[18]
#define T_factor _p[19]
#define diffuse _p[20]
#define lamd _p[21]
#define nd _p[22]
#define i _p[23]
#define ic _p[24]
...
#define tsyn _p[234]
#define Mres _p[235]
#define numpulses _p[236]
#define tzero _p[237]
#define gbar_Q10 _p[238]
#define Q10 _p[239]
#define y _p[240]
#define DC _p[241]
#define DO _p[242]
...
#define diffusione diffusione_GRANULE_Ampa_stoch_vi
#define imax imax_GRANULE_Ampa_stoch_vi
 extern double diffusione( _threadargsproto_ );
 extern double imax( _threadargsprotocomma_ double , double );
 /* declare global and static user variables */
#define u0 u0_GRANULE_Ampa_stoch_vi
 double u0 = 0;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "u0_GRANULE_Ampa_stoch_vi", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "u0_GRANULE_Ampa_stoch_vi", "1",
 "gmax", "pS",
 "Rd", "um",
 "Diff", "um2/ms",
 "Cdur", "ms",
 ...
 "u0_GRANULE_Ampa_stoch_vi", &u0_GRANULE_Ampa_stoch_vi,
 0,0
};
...
static void nrn_alloc(Prop* _prop) {
  ...
  if (nrn_point_prop_) {
	...
	_ppvar = nrn_point_prop_->dparam;
 	...
 	_p = nrn_prop_data_alloc(_mechtype, 247, _prop);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _GRANULE_Ampa_stoch_vi_reg() {
	int _vectorized = 1;
  _initlists();
...
#endif
  hoc_register_prop_size(_mechtype, 247, 4);
 ...
 pnt_receive_size[_mechtype] = 4;
 	...
 	ivoc_help("help ?1 GRANULE_Ampa_stoch_vi /home/stefano/Documenti/paperRevision/GL_Model/x86_64/GRANULE_Ampa_stoch_vi.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/synapse/GRANULE_Ampa_stoch_vi.mod";
static const char* nmodl_file_text = 
  "TITLE \n"
  "\n"
  "COMMENT\n"
