...
#define nrn_init _nrn_init__GRANULE_KM
#define _nrn_initial _nrn_initial__GRANULE_KM
#define nrn_cur _nrn_cur__GRANULE_KM
#define _nrn_current _nrn_current__GRANULE_KM
#define nrn_jacob _nrn_jacob__GRANULE_KM
#define nrn_state _nrn_state__GRANULE_KM
#define _net_receive _net_receive__GRANULE_KM 
#define _f_rate _f_rate__GRANULE_KM 
#define rate rate__GRANULE_KM 
#define states states__GRANULE_KM 
...
#define V0_ninf _p[6]
#define B_ninf _p[7]
#define Q10_diff _p[8]
#define Q10_channel _p[9]
#define gbar _p[10]
#define ic _p[11]
#define n_inf _p[12]
#define tau_n _p[13]
#define g _p[14]
#define alpha_n _p[15]
#define beta_n _p[16]
#define gbar_Q10 _p[17]
#define n _p[18]
#define ek _p[19]
#define Dn _p[20]
#define ik _p[21]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GRANULE_KM", _hoc_setdata,
 "alp_n_GRANULE_KM", _hoc_alp_n,
 "bet_n_GRANULE_KM", _hoc_bet_n,
 "rate_GRANULE_KM", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GRANULE_KM
#define bet_n bet_n_GRANULE_KM
...
#define usetable usetable_GRANULE_KM
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_GRANULE_KM", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_n_GRANULE_KM", "/ms",
 "Kalpha_n_GRANULE_KM", "mV",
 "V0alpha_n_GRANULE_KM", "mV",
 "Abeta_n_GRANULE_KM", "/ms",
 "Kbeta_n_GRANULE_KM", "mV",
 "V0beta_n_GRANULE_KM", "mV",
 "V0_ninf_GRANULE_KM", "mV",
 "B_ninf_GRANULE_KM", "mV",
 "gbar_GRANULE_KM", "mho/cm2",
 "ic_GRANULE_KM", "mA/cm2",
 "tau_n_GRANULE_KM", "ms",
 "g_GRANULE_KM", "mho/cm2",
 "alpha_n_GRANULE_KM", "/ms",
 "beta_n_GRANULE_KM", "/ms",
 "gbar_Q10_GRANULE_KM", "mho/cm2",
 0,0
};
 ...
 "usetable_GRANULE_KM", &usetable_GRANULE_KM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRANULE_KM /home/stefano/Documenti/paperRevision/GL_Model/x86_64/GRANULE_KM.mod\n");
...
double alp_n ( _threadargsprotocomma_ double _lv ) {
   double _lalp_n;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel , ( ( celsius - 22.0 ) / 10.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/granule/GRANULE_KM.mod";
static const char* nmodl_file_text = 
  ...
  "	Q10_diff	= 1.5\n"
  "	Q10_channel	= 3\n"
  "	gbar= 0.00025 (mho/cm2) :0.00003 (mho/cm2) \n"
  "	ek = -84.69 (mV) \n"
  "	celsius (degC)\n"
  "} \n"
  "\n"
