...
#define Q10_channel_alp_m _p[13]
#define Q10_channel_bet_m _p[14]
#define Q10_channel_alp_h _p[15]
#define Q10_channel_bet_h _p[16]
#define gbar _p[17]
#define ic _p[18]
#define m_inf _p[19]
#define h_inf _p[20]
...
#define usetable usetable_GRANULE_NA
 ...
 "alpha_m_GRANULE_NA", "/ms",
 "beta_m_GRANULE_NA", "/ms",
 "alpha_h_GRANULE_NA", "/ms",
 "beta_h_GRANULE_NA", "/ms",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRANULE_NA /home/stefano/Documenti/paperRevision/GL_Model/x86_64/GRANULE_NA.mod\n");
...
double alp_m ( _threadargsprotocomma_ double _lv ) {
   double _lalp_m;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel_alp_m , ( ( celsius - 20.0 ) / 10.0 ) ) ;
...
double bet_m ( _threadargsprotocomma_ double _lv ) {
   double _lbet_m;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel_bet_m , ( ( celsius - 20.0 ) / 10.0 ) ) ;
...
double alp_h ( _threadargsprotocomma_ double _lv ) {
   double _lalp_h;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel_alp_h , ( ( celsius - 20.0 ) / 10.0 ) ) ;
...
double bet_h ( _threadargsprotocomma_ double _lv ) {
   double _lbet_h;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel_bet_h , ( ( celsius - 20.0 ) / 10.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/granule/GRANULE_NA.mod";
static const char* nmodl_file_text = 
  ...
  "	\n"
  "	Abeta_m = 12 (/ms)\n"
  "	Kbeta_m = -18.182 (mV) :-18.182 (mV)\n"
  "	V0beta_m = -44 (mV)\n"
  "\n"
  "	Aalpha_h  = 0.105 (/ms)\n"
  "	Kalpha_h  = -3.333 (mV) :-3.333 (mV)\n"
  "	V0alpha_h = -44 (mV)\n"
  " \n"
  "	Abeta_h  = 0.75 (/ms)\n"
  "	Kbeta_h  = -5 (mV)\n"
