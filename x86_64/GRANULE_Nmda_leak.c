...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 0);
 	...
 	ivoc_help("help ?1 GRANULE_Nmda_leak /home/stefano/Documenti/paperRevision/GL_Model/x86_64/GRANULE_Nmda_leak.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/synapse/GRANULE_Nmda_leak.mod";
static const char* nmodl_file_text = 
  "TITLE NMDA leakage\n"
  "COMMENT\n"
