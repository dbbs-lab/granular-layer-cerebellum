...
#define B_minf _p[7]
#define gbar _p[8]
#define Q10_diff _p[9]
#define Q10_channel _p[10]
#define ina _p[11]
#define ic _p[12]
#define m_inf _p[13]
#define tau_m _p[14]
...
#define usetable usetable_GRANULE_PNA
 ...
 "alpha_m_GRANULE_PNA", "/ms",
 "beta_m_GRANULE_PNA", "/ms",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GRANULE_PNA /home/stefano/Documenti/paperRevision/GL_Model/x86_64/GRANULE_PNA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/granule/GRANULE_PNA.mod";
static const char* nmodl_file_text = 
  ...
  "	B_minf 		= 5 (mV)			: CONST\n"
  "	v (mV) \n"
  "	gbar		= 2e-5 (mho/cm2) :3e-5 (mho/cm2) \n"
  "	Q10_diff	= 1.5\n"
  "	Q10_channel	= 3\n"
  "	ena 		= 87.39 (mV) \n"
  "	celsius (degC)\n"
