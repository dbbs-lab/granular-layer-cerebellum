...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "cai0_Golgi_CALC", "mM",
 "beta_Golgi_CALC", "/ms",
 "beta_Q10_Golgi_CALC", "mho/cm2",
 "ca_pump_i_Golgi_CALC", "mA",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 Golgi_CALC /home/stefano/Documenti/paperRevision/GL_Model/x86_64/Golgi_CALC.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ca_pump_i = 2.0 * beta_Q10 * ( cai - cai0 ) ;
   ic = ca_pump_i ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/golgi/Golgi_CALC.mod";
static const char* nmodl_file_text = 
