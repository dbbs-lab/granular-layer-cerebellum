...
#define nrn_init _nrn_init__Golgi_KV
#define _nrn_initial _nrn_initial__Golgi_KV
#define nrn_cur _nrn_cur__Golgi_KV
#define _nrn_current _nrn_current__Golgi_KV
#define nrn_jacob _nrn_jacob__Golgi_KV
#define nrn_state _nrn_state__Golgi_KV
#define _net_receive _net_receive__Golgi_KV 
#define _f_rate _f_rate__Golgi_KV 
#define rate rate__Golgi_KV 
#define states states__Golgi_KV 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "alp_n_Golgi_KV", _hoc_alp_n,
 "bet_n_Golgi_KV", _hoc_bet_n,
 "linoid_Golgi_KV", _hoc_linoid,
 "rate_Golgi_KV", _hoc_rate,
 0, 0
};
#define alp_n alp_n_Golgi_KV
#define bet_n bet_n_Golgi_KV
#define linoid linoid_Golgi_KV
...
#define Abeta_n Abeta_n_Golgi_KV
 double Abeta_n = 0.125;
#define Aalpha_n Aalpha_n_Golgi_KV
 double Aalpha_n = -0.01;
#define Kbeta_n Kbeta_n_Golgi_KV
 double Kbeta_n = -80;
#define Kalpha_n Kalpha_n_Golgi_KV
 double Kalpha_n = -10;
#define V0beta_n V0beta_n_Golgi_KV
 double V0beta_n = -36;
#define V0alpha_n V0alpha_n_Golgi_KV
 double V0alpha_n = -26;
#define usetable usetable_Golgi_KV
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Golgi_KV", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_n_Golgi_KV", "/ms-mV",
 "Kalpha_n_Golgi_KV", "mV",
 "V0alpha_n_Golgi_KV", "mV",
 "Abeta_n_Golgi_KV", "/ms",
 "Kbeta_n_Golgi_KV", "mV",
 "V0beta_n_Golgi_KV", "mV",
 "gbar_Golgi_KV", "mho/cm2",
 "ik_Golgi_KV", "mA/cm2",
 "tau_n_Golgi_KV", "ms",
 "g_Golgi_KV", "mho/cm2",
 "tcorr_Golgi_KV", "1",
 "gbar_Q10_Golgi_KV", "mho/cm2",
 0,0
};
 ...
 "Aalpha_n_Golgi_KV", &Aalpha_n_Golgi_KV,
 "Kalpha_n_Golgi_KV", &Kalpha_n_Golgi_KV,
 "V0alpha_n_Golgi_KV", &V0alpha_n_Golgi_KV,
 "Abeta_n_Golgi_KV", &Abeta_n_Golgi_KV,
 "Kbeta_n_Golgi_KV", &Kbeta_n_Golgi_KV,
 "V0beta_n_Golgi_KV", &V0beta_n_Golgi_KV,
 "usetable_Golgi_KV", &usetable_Golgi_KV,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Golgi_KV /home/stefano/Documenti/paperRevision/GL_Model/x86_64/Golgi_KV.mod\n");
...
double alp_n ( _threadargsprotocomma_ double _lv ) {
   double _lalp_n;
 tcorr = pow( Q10_channel , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   _lalp_n = tcorr * Aalpha_n * linoid ( _threadargscomma_ _lv - V0alpha_n , Kalpha_n ) ;
...
double bet_n ( _threadargsprotocomma_ double _lv ) {
   double _lbet_n;
 tcorr = pow( Q10_channel , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   _lbet_n = tcorr * Abeta_n * exp ( ( _lv - V0beta_n ) / Kbeta_n ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/golgi/Golgi_KV.mod";
static const char* nmodl_file_text = 
