...
#define nrn_init _nrn_init__Golgi_PF_NMDA
#define _nrn_initial _nrn_initial__Golgi_PF_NMDA
#define nrn_cur _nrn_cur__Golgi_PF_NMDA
#define _nrn_current _nrn_current__Golgi_PF_NMDA
#define nrn_jacob _nrn_jacob__Golgi_PF_NMDA
#define nrn_state _nrn_state__Golgi_PF_NMDA
#define _net_receive _net_receive__Golgi_PF_NMDA 
#define _f_rates _f_rates__Golgi_PF_NMDA 
#define rates rates__Golgi_PF_NMDA 
#define state state__Golgi_PF_NMDA 
...
#define gmax _p[0]
#define syntype _p[1]
#define synfunctype _p[2]
#define tau1_Fix _p[3]
#define tau2_Fix _p[4]
#define e _p[5]
#define gmax_factor _p[6]
#define i _p[7]
#define g _p[8]
#define A _p[9]
#define B _p[10]
...
#define Q10_channel Q10_channel_Golgi_PF_NMDA
 double Q10_channel = 2.4;
#define Q10_diff Q10_diff_Golgi_PF_NMDA
 double Q10_diff = 1.1;
#define k_block k_block_Golgi_PF_NMDA
 double k_block = 13;
#define total total_Golgi_PF_NMDA
 double total = 0;
#define usetable usetable_Golgi_PF_NMDA
 double usetable = 1;
#define v0_block v0_block_Golgi_PF_NMDA
 double v0_block = -20;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2_Fix", 1e-09, 1e+09,
 "tau1_Fix", 1e-09, 1e+09,
 "usetable_Golgi_PF_NMDA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "v0_block_Golgi_PF_NMDA", "mV",
 "k_block_Golgi_PF_NMDA", "mV",
 "total_Golgi_PF_NMDA", "uS",
 "gmax", "pS",
 "tau1_Fix", "ms",
 "tau2_Fix", "ms",
 "e", "mV",
 ...
 "Q10_diff_Golgi_PF_NMDA", &Q10_diff_Golgi_PF_NMDA,
 "Q10_channel_Golgi_PF_NMDA", &Q10_channel_Golgi_PF_NMDA,
 "v0_block_Golgi_PF_NMDA", &v0_block_Golgi_PF_NMDA,
 "k_block_Golgi_PF_NMDA", &k_block_Golgi_PF_NMDA,
 "total_Golgi_PF_NMDA", &total_Golgi_PF_NMDA,
 "usetable_Golgi_PF_NMDA", &usetable_Golgi_PF_NMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Golgi_PF_NMDA /home/stefano/Documenti/paperRevision/GL_Model/x86_64/Golgi_PF_NMDA.mod\n");
 ...
 t = 0.0;
{
  ...
  B = B0;
 {
   double _ltp ;
 total = 0.0 ;
   gbar_Q10 = pow( Q10_diff , ( ( celsius - 23.0 ) / 10.0 ) ) ;
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 92 in file Golgi_PF_NMDA.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/synapse/Golgi_PF_NMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
