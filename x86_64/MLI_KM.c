...
#define nrn_init _nrn_init__MLI_KM
#define _nrn_initial _nrn_initial__MLI_KM
#define nrn_cur _nrn_cur__MLI_KM
#define _nrn_current _nrn_current__MLI_KM
#define nrn_jacob _nrn_jacob__MLI_KM
#define nrn_state _nrn_state__MLI_KM
#define _net_receive _net_receive__MLI_KM 
#define _f_rate _f_rate__MLI_KM 
#define rate rate__MLI_KM 
#define states states__MLI_KM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_MLI_KM", _hoc_setdata,
 "alp_n_MLI_KM", _hoc_alp_n,
 "bet_n_MLI_KM", _hoc_bet_n,
 "rate_MLI_KM", _hoc_rate,
 0, 0
};
#define alp_n alp_n_MLI_KM
#define bet_n bet_n_MLI_KM
...
#define Abeta_n Abeta_n_MLI_KM
 double Abeta_n = 0.0033;
#define Aalpha_n Aalpha_n_MLI_KM
 double Aalpha_n = 0.0033;
#define B_ninf B_ninf_MLI_KM
 double B_ninf = 6;
#define Kbeta_n Kbeta_n_MLI_KM
 double Kbeta_n = -20;
#define Kalpha_n Kalpha_n_MLI_KM
 double Kalpha_n = 40;
#define V0_ninf V0_ninf_MLI_KM
 double V0_ninf = -35;
#define V0beta_n V0beta_n_MLI_KM
 double V0beta_n = -30;
#define V0alpha_n V0alpha_n_MLI_KM
 double V0alpha_n = -30;
#define usetable usetable_MLI_KM
 double usetable = 1;
 ...
 "Aalpha_n_MLI_KM", &Aalpha_n_MLI_KM,
 "Kalpha_n_MLI_KM", &Kalpha_n_MLI_KM,
 "V0alpha_n_MLI_KM", &V0alpha_n_MLI_KM,
 "Abeta_n_MLI_KM", &Abeta_n_MLI_KM,
 "Kbeta_n_MLI_KM", &Kbeta_n_MLI_KM,
 "V0beta_n_MLI_KM", &V0beta_n_MLI_KM,
 "V0_ninf_MLI_KM", &V0_ninf_MLI_KM,
 "B_ninf_MLI_KM", &B_ninf_MLI_KM,
 "usetable_MLI_KM", &usetable_MLI_KM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 MLI_KM /home/stefano/Documenti/paperRevision/GL_Model/x86_64/MLI_KM.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/mli/MLI_KM.mod";
static const char* nmodl_file_text = 
