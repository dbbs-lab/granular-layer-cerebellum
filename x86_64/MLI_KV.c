...
#define nrn_init _nrn_init__MLI_KV
#define _nrn_initial _nrn_initial__MLI_KV
#define nrn_cur _nrn_cur__MLI_KV
#define _nrn_current _nrn_current__MLI_KV
#define nrn_jacob _nrn_jacob__MLI_KV
#define nrn_state _nrn_state__MLI_KV
#define _net_receive _net_receive__MLI_KV 
#define _f_rate _f_rate__MLI_KV 
#define rate rate__MLI_KV 
#define states states__MLI_KV 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_MLI_KV", _hoc_setdata,
 "alp_n_MLI_KV", _hoc_alp_n,
 "bet_n_MLI_KV", _hoc_bet_n,
 "linoid_MLI_KV", _hoc_linoid,
 "rate_MLI_KV", _hoc_rate,
 0, 0
};
#define alp_n alp_n_MLI_KV
#define bet_n bet_n_MLI_KV
#define linoid linoid_MLI_KV
...
#define Abeta_n Abeta_n_MLI_KV
 double Abeta_n = 0.125;
#define Aalpha_n Aalpha_n_MLI_KV
 double Aalpha_n = -0.01;
#define Kbeta_n Kbeta_n_MLI_KV
 double Kbeta_n = -80;
#define Kalpha_n Kalpha_n_MLI_KV
 double Kalpha_n = -10;
#define V0beta_n V0beta_n_MLI_KV
 double V0beta_n = -36;
#define V0alpha_n V0alpha_n_MLI_KV
 double V0alpha_n = -26;
#define usetable usetable_MLI_KV
 double usetable = 1;
 ...
 "Aalpha_n_MLI_KV", &Aalpha_n_MLI_KV,
 "Kalpha_n_MLI_KV", &Kalpha_n_MLI_KV,
 "V0alpha_n_MLI_KV", &V0alpha_n_MLI_KV,
 "Abeta_n_MLI_KV", &Abeta_n_MLI_KV,
 "Kbeta_n_MLI_KV", &Kbeta_n_MLI_KV,
 "V0beta_n_MLI_KV", &V0beta_n_MLI_KV,
 "usetable_MLI_KV", &usetable_MLI_KV,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 MLI_KV /home/stefano/Documenti/paperRevision/GL_Model/x86_64/MLI_KV.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/mli/MLI_KV.mod";
static const char* nmodl_file_text = 
