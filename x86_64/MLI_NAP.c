...
#define nrn_init _nrn_init__MLI_NAP
#define _nrn_initial _nrn_initial__MLI_NAP
#define nrn_cur _nrn_cur__MLI_NAP
#define _nrn_current _nrn_current__MLI_NAP
#define nrn_jacob _nrn_jacob__MLI_NAP
#define nrn_state _nrn_state__MLI_NAP
#define _net_receive _net_receive__MLI_NAP 
#define _f_rate _f_rate__MLI_NAP 
#define rate rate__MLI_NAP 
#define states states__MLI_NAP 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_MLI_NAP", _hoc_setdata,
 "alp_m_MLI_NAP", _hoc_alp_m,
 "bet_m_MLI_NAP", _hoc_bet_m,
 "linoid_MLI_NAP", _hoc_linoid,
 "rate_MLI_NAP", _hoc_rate,
 0, 0
};
#define alp_m alp_m_MLI_NAP
#define bet_m bet_m_MLI_NAP
#define linoid linoid_MLI_NAP
...
#define Abeta_m Abeta_m_MLI_NAP
 double Abeta_m = 0.62;
#define Aalpha_m Aalpha_m_MLI_NAP
 double Aalpha_m = -0.91;
#define B_minf B_minf_MLI_NAP
 double B_minf = 5;
#define Kbeta_m Kbeta_m_MLI_NAP
 double Kbeta_m = 5;
#define Kalpha_m Kalpha_m_MLI_NAP
 double Kalpha_m = -5;
#define V0_minf V0_minf_MLI_NAP
 double V0_minf = -43;
#define V0beta_m V0beta_m_MLI_NAP
 double V0beta_m = -40;
#define V0alpha_m V0alpha_m_MLI_NAP
 double V0alpha_m = -40;
#define usetable usetable_MLI_NAP
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_MLI_NAP", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_m_MLI_NAP", "/mV-ms",
 "Kalpha_m_MLI_NAP", "mV",
 "V0alpha_m_MLI_NAP", "mV",
 "Abeta_m_MLI_NAP", "/mV-ms",
 "Kbeta_m_MLI_NAP", "mV",
 "V0beta_m_MLI_NAP", "mV",
 "V0_minf_MLI_NAP", "mV",
 "B_minf_MLI_NAP", "mV",
 "gbar_MLI_NAP", "mho/cm2",
 "ina_MLI_NAP", "mA/cm2",
 "tau_m_MLI_NAP", "ms",
 "g_MLI_NAP", "mho/cm2",
 "tcorr_MLI_NAP", "1",
 "gbar_Q10_MLI_NAP", "mho/cm2",
 0,0
};
 ...
 "Aalpha_m_MLI_NAP", &Aalpha_m_MLI_NAP,
 "Kalpha_m_MLI_NAP", &Kalpha_m_MLI_NAP,
 "V0alpha_m_MLI_NAP", &V0alpha_m_MLI_NAP,
 "Abeta_m_MLI_NAP", &Abeta_m_MLI_NAP,
 "Kbeta_m_MLI_NAP", &Kbeta_m_MLI_NAP,
 "V0beta_m_MLI_NAP", &V0beta_m_MLI_NAP,
 "V0_minf_MLI_NAP", &V0_minf_MLI_NAP,
 "B_minf_MLI_NAP", &B_minf_MLI_NAP,
 "usetable_MLI_NAP", &usetable_MLI_NAP,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 MLI_NAP /home/stefano/Documenti/paperRevision/GL_Model/x86_64/MLI_NAP.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/mli/MLI_NAP.mod";
static const char* nmodl_file_text = 
