...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 HalfGap /home/stefano/Documenti/paperRevision/GL_Model/x86_64/gapj.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/stefano/Documenti/paperRevision/GL_Model/templates/gapj/gapj.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
